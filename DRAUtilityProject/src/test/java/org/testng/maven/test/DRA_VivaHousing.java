...
public class DRA_VivaHousing extends BaseClass {
	...
	public void screenShot(ITestResult vivaHousingResult) {
		// using ITestResult.FAILURE is equals to result.getStatus then it enter into if
		// condition
		if (ITestResult.FAILURE == vivaHousingResult.getStatus()) {
			try {
				...
				FileUtils.copyFile(src,
						new File(System.getProperty("user.dir").concat(vivaHousingResult.getName() + ".png")));
	...
	public static String vivaHousingTest(String companyFilePath, String leadsFilePath) throws Exception {
	...
	public static void main(String[] args) throws Exception {
		...
		String result = vivaHousingTest(companyFilePath, leadsFilePath);
