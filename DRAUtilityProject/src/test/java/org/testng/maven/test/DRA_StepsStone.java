...
public class DRA_StepsStone extends BaseClass {
	...
	public static String stepStoneTest(String companyFilePath, String leadsFilePath) throws Exception {
		...
		List<String> channelPartnerNameList = new ArrayList<String>();
		List<String> channelPartnerMobileNumberList = new ArrayList<String>();
		List<String> channelPartnerEmailList = new ArrayList<String>();
		...
		for (int row = 1; row < companyDetailsTotalNoOfRows; row++) {
			...
			case "Steps Stone":
				...
				for (int rows = 1; rows < leadDetailsTotalNoOfRows; rows++) {
					...
					channelPartnerNameList.add(channelPartnerName);
					channelPartnerMobileNumberList.add(channelPartnerMobileNumber);
					...
					try {
						...
						for (WebElement webElement : projectNames) {
							...
							if (projectNameList.equalsIgnoreCase(leadProject)) {
